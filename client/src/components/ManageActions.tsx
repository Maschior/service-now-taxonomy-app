...
import { Plus, X, Activity, Edit2, Trash2, Globe, Home, Check } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white m-0">Ações</h1>
              <p className="text-gray-500 dark:text-gray-400 mt-1">Gerencie as ações para cada incidente.</p>
            </div>
          </div>
          <button 
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          {loading ? (
            ...
            <div className="p-8 text-center text-gray-500">Nenhuma ação cadastrada.</div>
          ) : (
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <th className="py-3 px-4 text-sm font-semibold text-gray-600 dark:text-gray-300">Incidente</th>
                ...
                <tbody>
                  {filteredItems.map(act => {
                    ...
                    return (
                    <tr key={act._id} className={`border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group ${selectedIds.includes(act._id) ? "bg-indigo-50/50 dark:bg-indigo-900/20" : ""}`}>
                      ...
                      <td className="py-3 px-4 text-right">
                        {editingId === act._id ? (
                          <div className="flex justify-end gap-1">
                            <button onClick={() => saveInlineEdit(act)} className="p-1.5 text-green-600 hover:bg-green-50 rounded" title="Salvar">
                              <Check size={16} />
                            </button>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-fade-in-up">
            <div className="p-5 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <Plus className="text-indigo-500 w-5 h-5"/> Nova Ação
              </h3>
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Incidente</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nome da Ação</label>
                <input
                  ref={nameInputRef}
                  autoFocus
                  type="text"
